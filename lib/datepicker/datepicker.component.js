...
var GWDatepickerComponent = (function (_super) {
    ...
    function GWDatepickerComponent(config, input, loader) {
        ...
        _this.input = input;
        _this.loader = loader;
        _this.CancelCalendarDaterangepicker = new EventEmitter();
        return _this;
    }
    ...
    GWDatepickerComponent.prototype.datepickerInit = function (config) {
        ...
        $(this.input.nativeElement).find('#dateHost').on('cancel.daterangepicker', function (ev, picker) {
            _this.value = null;
        });
    };
    ...
    GWDatepickerComponent.prototype.datepickerPreInit = function (config) {
        ...
        if (typeof moment === 'undefined' || typeof $ === 'undefined' || typeof daterangepicker === 'undefined') {
            var jqueryPath = config.jqueryPath, momentPath = config.momentPath, datepickerPath = config.datepickerPath;
...
GWDatepickerComponent.propDecorators = {
    'options': [{ type: Input },],
    'label': [{ type: Input },],
    'CancelCalendarDaterangepicker': [{ type: Output },],
};
